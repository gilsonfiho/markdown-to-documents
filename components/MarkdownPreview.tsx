    ...
    <div className="markdown-preview prose prose-sm max-w-none">
      <ReactMarkdown
        ...
        components={{
          h1: (props: any) => (
            <h1
              className="text-3xl font-bold text-neutral-900 mt-8 mb-4 border-b-2 border-neutral-200 pb-2"
              {...props}
            />
          ),
          h2: (props: any) => (
          ...
          a: (props: any) => (
            <a
              className="text-blue-600 hover:text-blue-700 underline hover:underline-offset-2"
              {...props}
            />
          ),
